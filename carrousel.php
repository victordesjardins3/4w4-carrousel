 ...
 * Author: Victor Desjardins
 * Author uri: https://github.com/victordesjardins3
 * Description: Permet d'afficher les images d'une galerie dans un boîte modale navigable
 */
